...
namespace Api.Middlewares
{
    public class ExceptionHandlerMiddleware
    {
        ...
        private async Task ExceptionResponseAsync(Exception exception, HttpContext context)
        {
            ...
            await context.Response.Body.WriteAsync(Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(new ExceptionResponse(exception.Message, JsonConvert.SerializeObject(exception)))));
