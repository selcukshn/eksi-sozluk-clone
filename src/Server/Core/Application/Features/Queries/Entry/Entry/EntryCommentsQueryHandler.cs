...
{
    public class EntryCommentsQueryHandler : GenericHandler<IEntryCommentRepository, EntryCommentsQuery, List<EntryCommentsViewModel>>
    {
        public EntryCommentsQueryHandler(IEntryCommentRepository repository, IMapper mapper) : base(repository, mapper) { }

        public override async Task<List<EntryCommentsViewModel>> Handle(EntryCommentsQuery request, CancellationToken cancellationToken)
        {
